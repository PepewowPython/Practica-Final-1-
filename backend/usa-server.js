...
const DB_PATH = path.join(__dirname, 'usa-db.json');

const JWT_SECRET = process.env.JWT_SECRET || 'rutas-inseguras-super-secret-key';

const app = express();
const PORT = process.env.USA_PORT || 5001;
...
async function readDB() {
  try {
    ...
    console.error('Error reading usa-db.json, returning empty template:', error);
